...
public class ImportedFile {
	...
	public ArrayList<String> importfile( ) throws IOException{
	  ...
	  //  String str=replaceComments(line);
	     String str=line;
	    text.add(str);
	   //this System.out.println("IOEXP: "+line);
	    }
	    reader.close();
	...
	//this	System.out.println(word.toLowerCase()+"\n");
			}
		}
		}
		//this	System.out.println(words.size());
		return (String[])words.toArray(new String[words.size()]);
	
	}
	 
	/**
	 * Uses LovinsStemmer to remove the endings,calculates the number of each word in the file and adds this result to a hashmap.
	...
	public HashMap<String,Integer> mapCode2(String[] splitwords){
		...
		//System.out.println("words code "+wordsOfCode);
		return wordsOfCode;
	}
